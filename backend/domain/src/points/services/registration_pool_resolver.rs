...
//
// Per design §5.4 / §4.3.2 (credit-bucket): the target Bucket for registration
...
// the infra layer (BE-D07). `RegistrationService` (BE-D05) consumes this port to
...
///   do not silently fall back to any implicit pool — see design A4/A5).
