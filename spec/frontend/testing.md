...
- 测试层级选择以 [环境与测试总览](/spec/core/environment-and-testing-guide.md) 为准。
...
test('shows error message when API returns 401', async () => {
  server.use(
    http.post('/api/:realmId/auth/login', () =>
...
- 规则见 [data-testid 编写规范](/spec/agents/frontend/testid-standards.md)
...
- [data-testid 编写规范](/spec/agents/frontend/testid-standards.md)
- [环境与测试总览](/spec/core/environment-and-testing-guide.md)
- [质量门禁](/spec/core/quality.md)
