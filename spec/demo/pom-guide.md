...
export class UsersPage extends BasePage {
  ...
  async gotoUsers(realmId = 'demo-realm'): Promise<void> {
    await this.goto(`/${realmId}/users`)
  }
...
test('user flow', async ({ page }) => {
  ...
  await users.gotoUsers('demo-realm')
...
- E2E 执行与隔离规则：见 [Demo E2E 测试指南](e2e-testing.md)
- 选择器策略：见 [选择器策略最佳实践](/spec/agents/demo/selector-strategy.md)
- 测试维护与排障：见 [测试维护指南](test-maintenance.md)

---

## 相关文档

- [Demo E2E 测试指南](e2e-testing.md)
- [选择器策略最佳实践](/spec/agents/demo/selector-strategy.md)
- [测试维护指南](test-maintenance.md)
