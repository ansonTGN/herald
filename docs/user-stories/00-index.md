...
| Realm Admin | [02-realm-admin-user-stories.md](02-realm-admin-user-stories.md), [builtin_protection.md](builtin_protection.md) | 9 | [Users PRD](/docs/prd/core/users.md), [Permissions PRD](/docs/prd/auth/permissions.md), [Client Apps PRD](/docs/prd/integration/client-app.md), [Realm Settings PRD](/docs/prd/core/realm-settings.md) |
