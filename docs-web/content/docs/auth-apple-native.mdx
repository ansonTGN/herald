...
- [Apple native login PRD](https://github.com/timzaak/cas-2/blob/main/docs/prd/auth/support-mobile-apple-login.md) — product scope, business rules, acceptance goals
- [Apple native login user stories](https://github.com/timzaak/cas-2/blob/main/docs/user-stories/auth/support-mobile-apple-login.md) — US-AL-001..003 acceptance scenarios
